...
export default class RecordingEngine {
  ...
  async _encodeAndWriteFrameSync(pixels, width, height, frameIndex) {
    ...
    try {
      ...
      // Update preview thumbnail every 5th frame during recording, unless we are building a ZIP which is 1 in 10 frames max
      var thumbInterval = (this._pipeline === "zip") ? 10 : 5;
      if (frameIndex % thumbInterval === 0) {
