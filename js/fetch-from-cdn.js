// =============================================================================
// sine-gordon-lab — js/fetch-from-cdn.js
// FFmpeg.wasm asset fetching with local-to-CDN fallback and cryptographic
// integrity validation. Used by assembly.js to load FFmpeg core binaries.
// =============================================================================

// Hashes matched to @ffmpeg/core@0.12.6 / @ffmpeg/core-mt@0.12.6 from CDN
const TRUSTED_HASHES = {
  "ffmpeg-core-mt-wasm": "6a6863fa9f08ee79c47363547421e12a90624b9bbbd8c10ebf7d5967cab14649",
  "ffmpeg-core-st-wasm": "2390efa7fb66e7e42dbae15427571a5ffc96b829480904c30f471f0a78967f61",
  "ffmpeg-core-mt-js":   "62f5f5f468a37861da12c4581c321bb5ca8ba2f7b776377e08dd2ab72de293f9",
  "ffmpeg-core-st-js":   "b266ab5b952555881dd6310663986994a182acb2b7ff25cf10a25f7a37ac2b21",
  "ffmpeg-core-worker":  "97322a227c5f3d5ccfd0d0825890a6deeba137106a09b633ca75cadf49ddd2cb"
};
...
function isHtmlFallback(arrayBuffer) {
  try {
...
async function validateIntegrity(arrayBuffer, url) {
  ...
  if (cryptoSuccessful && fileKey) {
    const expectedHash = TRUSTED_HASHES[fileKey];
